package com.msvc.hexagonal.zara.infrastructure.adapters.repository;
...
public interface SpringDatePriceRepository extends JpaRepository <PriceEntity, Long> {
    @Query(value = """
        ...
        LIMIT 1
        """, nativeQuery = true)
    Optional<PriceEntity> getPriceEntity(Long productId, Long brandId, java.time.LocalDateTime inputDate);
}
